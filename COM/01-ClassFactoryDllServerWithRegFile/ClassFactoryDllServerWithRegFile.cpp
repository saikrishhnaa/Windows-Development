...
BOOL WINAPI DllMain(HMODULE hModule, DWORD dwReason, LPVOID lpReserved)
{
	...
	fptr = fopen("C:\\WinDev2022\\02-COM\\01-ClassFactory\\02-ClientOfClassFactoryDllServerWithRegFile\\program5.txt", "w");
	...
	fclose(fptr);
	MessageBox(NULL, TEXT("DLL"), TEXT("DLL Status"), MB_OK);
	//Code
	switch (dwReason)
	{
