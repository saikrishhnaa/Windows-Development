...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMSG, WPARAM wParam, LPARAM lParam)
{
	...
	switch (iMSG)
	{
		case WM_CREATE:
			...
			fptr = fopen("C:\\WinDev2022\\02-COM\\01-ClassFactory\\02-ClientOfClassFactoryDllServerWithRegFile\\program.txt", "w");
